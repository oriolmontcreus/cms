<script lang="ts">
    ...
    function calculateTranslationStats() {
        ...
        pages.forEach((page) => {
            if (page.components) {
                page.components.forEach((component) => {
                    ...
                    const { translatableFieldsCount, translatedCount } =
                        countTranslatableFields(component);
                    totalFields +=
                        translatableFieldsCount * availableLocales.length;
        ...
        translationStats = {
            totalTranslatableFields: Math.floor(
                totalFields / availableLocales.length,
            ),
            translatedFields,
    ...
    function countTranslatableFields(component: any): {
    ...
    function countTranslatedForLocale(
        component: any,
        localeCode: string,
    ): number {
        let translated = 0;
        ...
        if (component.componentName) {
            ...
            translated = Object.keys(
                ...
                (key) =>
                    key !== "translations" &&
                    component.formData.translations[localeCode][key],
            ).length;
        }
                    ...
                    <div class="max-w-6xl mx-auto space-y-6">
                        ...
                        >
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div class="text-2xl font-bold">
                                        {translationStats.totalTranslatableFields}
                                    </div>
                                    <p class="text-xs text-muted-foreground">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div class="text-2xl font-bold">
                                        {translationStats.translatedFields}
                                    </div>
                                    <p class="text-xs text-muted-foreground">
                                        {translationStats.completionPercentage}%
                                        complete
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div class="text-2xl font-bold">
                                        {translationStats.missingTranslations}
                                    </div>
                                    <p class="text-xs text-muted-foreground">
                                        Translations needed
                                    </p>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle
                                    >Overall Translation Progress</CardTitle
                                >
                                <CardDescription>
                                    Complete progress across all languages and
                                    content
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-4">
                                <div class="space-y-2">
                                    <div class="flex justify-between text-sm">
                                        <span>Progress</span>
                                        <span
                                            >{translationStats.completionPercentage}%</span
                                        >
                                    </div>
                                    <Progress
                                        value={translationStats.completionPercentage}
                                        class="h-2"
                                    />
                                </div>
                                <div class="text-sm text-muted-foreground">
                                    {translationStats.translatedFields} of {translationStats.totalTranslatableFields *
                                        availableLocales.length} translations completed
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    See how complete each language translation
                                    is
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                {#each availableLocales as locale}
                                    {@const stats =
                                        translationStats.byLocale[locale.code]}
                                    <div class="space-y-3">
                                        <div
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            >
                                                <span
                                                    >{stats.translated} completed</span
                                                >
                                                <span
                                                    >{stats.total -
                                                        stats.translated} remaining</span
                                                >
                                            </div>
                                        </div>
                                    </div>
                            ...
                            >
                                ...
                                >
                                    <div class="text-left">
                                        ...
                                        >
                                            Complete any empty translation
                                            fields
                                        </div>
                                    </div>
                                </Button>
                                ...
                                <Button
                                    ...
                                    onclick={() =>
                                        goto(
                                            "/translations/wizard?mode=review",
                                        )}
                                >
                                    <div class="text-left">
                                        <div class="font-medium">
